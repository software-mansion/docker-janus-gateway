...
```
docker build -t swmansion/janus-gateway:0.11.3-0 .
```
...
docker run --rm \
 ...
 -ti swmansion/janus-gateway:0.11.3-0
```
...
See [janus.transport.rabbitmq.jcfg.sample](https://github.com/meetecho/janus-gateway/blob/v0.11.3/conf/janus.transport.rabbitmq.jcfg.sample)
...
See [janus.transport.websockets.jcfg.sample](https://github.com/meetecho/janus-gateway/blob/v0.11.3/conf/janus.transport.websockets.jcfg.sample)
in Janus Gateway's source code for detailed explanation of the parameters.
